...
//			            
		...
		JButton btnExibeEstados = new JButton("estados");
		btnExibeEstados.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				
				internalFrameG.exibeEstados();
			}
		});
		toolBar_1.add(btnExibeEstados);
